...
for res_f in os.listdir("/home/vpu/Repositories/SCT/TrackletNet/AIC19/txt_GPS_new/"):
    print(res_f)
    camid = res_f.split(".")[0]
    ...
    for line in open(osp.join("/home/vpu/Repositories/SCT/TrackletNet/AIC19/txt_GPS_new/", res_f)).readlines():
        tmp = line.strip("\n").split(",")
        f_id = tmp[0]
        obj_id = tmp[1]
